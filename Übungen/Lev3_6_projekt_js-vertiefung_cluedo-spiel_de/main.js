const suspectsArray = [{
  ...
  age: '45',
  description: 'He has a lot of connenctions',
  color: 'green'
},
{
  firstName: 'Dr.',
...
document.getElementById("button").addEventListener("click", () => {
  document.getElementById("weapon-p").innerHTML = Math.floor(Math.random() * weaponsArray.length)
  document.getElementById("room-p").innerHTML = Math.floor(Math.random() * roomsArray.length)
  document.getElementById("name-p").innerHTML = Math.floor(Math.random() * suspectsArray.length)
})
